(function(){
  ...
  const boards={
    overview:[['灰度前 dry-run 链路','ready','可在总览页一键顺序运行行情、研究、策略、风控、Paper、人工复核和订单预览。'],['安全旗标检查','ready','前端实时检查 can_submit_order、order_submit_enabled、real_order_submitted 等危险旗标。'],['实盘前安全审计','pending','后续阶段二十三接入 go/no-go 审计报告。'],['小资金灰度实盘','pending','必须在安全审计和人工确认后再进入。']],
