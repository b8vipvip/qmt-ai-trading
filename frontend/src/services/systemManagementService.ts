...
export interface SystemSummary { artifactRoot: string; taskCount: number; historyCount: number; apiConfigCount: number; enabledApiConfigCount: number; latestRunAt: string; runMode: string; liveTradingEnabled: boolean; orderSubmitEnabled: boolean; orderCancelEnabled: boolean; sourcePath?: string }
...
export interface ApiConfigRow { id: string; name: string; provider: string; baseUrl: string; account: string; xtdataPath: string; modelName: string; enabled: boolean; note: string; updatedAt: string; purposes: string[]; hasToken: boolean; tokenMasked: string; sourcePath?: string }
...
export function getSystemSummary() { return apiOrMock('/system/summary', { artifactRoot: '', taskCount: 0, historyCount: 0, apiConfigCount: 0, enabledApiConfigCount: 0, latestRunAt: '', runMode: 'research', liveTradingEnabled: false, orderSubmitEnabled: false, orderCancelEnabled: false } as SystemSummary); }
