...
```json
{
  ...
  "features": [
    ...
    {
      "feature": "QMT Gateway / xttrader Boundary",
      "status": "DISABLED_FOR_SAFETY",
      "api": "/api/v1/trading/xttrader-boundary/report",
      "note": "Stage90 boundary disabled",
      "read_only": true,
      "no_order_submitted": true
    },
    {
      "feature": "Account Readonly",
      "status": "MANUAL_CONFIRM_REQUIRED",
      "api": "/api/v1/account-readonly/status",
      "note": "disabled by default; manual confirmation required",
      "read_only": true,
      "no_order_submitted": true
    },
    {
      "feature": "Position Readonly",
      "status": "MANUAL_CONFIRM_REQUIRED",
      "api": "/api/v1/account-readonly/positions",
      "note": "disabled by default; manual confirmation required",
      "read_only": true,
      "no_order_submitted": true
    },
    {
      ...
      "status": "DISABLED_FOR_SAFETY",
      "api": "/api/v1/trading/xttrader-boundary/order-submit-gate",
    ...
    },
    {
      ...
      "note": "Stage89 paper trading dashboard/API",
      "read_only": true,
      "no_order_submitted": true
    },
    {
      ...
      "status": "INTERACTIVE",
      "api": "/api/v1/paper-trading/portfolio/latest",
      "note": "Stage89 shadow position/PnL API",
      "read_only": true,
      "no_order_submitted": true
    },
    {
