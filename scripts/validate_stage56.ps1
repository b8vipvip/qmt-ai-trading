...
Write-Log "Stage56 validation started $($StartedAt.ToString('o'))"
...
Run-Command "py -m pytest tests/test_real_cache_quality_stage56.py"
...
Print-File "real_cache_quality_stage56\real_cache_quality.md"
Print-File "real_cache_quality_stage56\long_sample_gap_fill.md"
Print-File "real_cache_quality_stage56\field_quality_review.md"
Print-File "real_cache_quality_stage56\next_backtest_attribution_plan.md"
...
if ($script:HadError) {
    Write-Log "Stage56 validation finished $($FinishedAt.ToString('o')) EXIT_CODE=1"
    Write-Error "Stage56 validation failed. Log: $LogPath"
    exit 1
}

Write-Log "Stage56 validation finished $($FinishedAt.ToString('o')) EXIT_CODE=0"
exit 0
