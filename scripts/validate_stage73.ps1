...
$LogPath = Join-Path $LogDir "stage73_validation_$Stamp.log"
$script:Failures = 0
...
Run-Step "generate stage73" @("py","scripts\run_local_console_help_docs.py","--repo-root",".","--output-dir","local_console_help_stage73","--acceptance-dir","local_console_acceptance_stage72","--review-dir","local_console_review_stage71","--drilldown-dir","local_console_drilldown_stage70","--grouping-dir","local_console_grouping_stage69","--refresh-dir","local_console_refresh_stage68")
Print-File "local_console_help_stage73\local_console_help_docs_report.md"
Print-File "local_console_help_stage73\help_home.md"
Print-File "local_console_help_stage73\page_help.md"
Print-File "local_console_help_stage73\feature_help.md"
Print-File "local_console_help_stage73\safety_help.md"
Print-File "local_console_help_stage73\faq.md"
Print-File "local_console_help_stage73\error_handling_guide.md"
Print-File "local_console_help_stage73\glossary.md"
Print-File "local_console_help_stage73\route_help_map.md"
Print-File "local_console_help_stage73\help_package_index.md"
Print-File "local_console_help_stage73\docs_safety_report.md"
Print-File "local_console_help_stage73\next_local_demo_package_plan.md"
...
Run-Step "daily help docs" @("py","scripts\run_daily_pipeline.py","--cache-root","market_data_test_stage73","--research-start","2026-03-21","--research-end","2026-06-18","--research-frequency","1d","--min-bars","40","--cached-strategy-top-n","2","--enable-local-console-help-docs","--local-console-help-docs-output-dir","local_console_help_stage73")
Run-Step "scheduled help docs" @("py","scripts\run_scheduled_daily_pipeline.py","--warmup-universe","--warmup-provider","mock","--universe-lookback-days","90","--warmup-frequency","1d","--cache-root","market_data_test_stage73","--data-source-mode","cached_real_first","--research-start","2026-03-21","--research-end","2026-06-18","--research-frequency","1d","--min-bars","40","--cached-strategy-top-n","2","--enable-local-console-help-docs","--local-console-help-docs-output-dir","local_console_help_stage73")
Run-Step "register preview" @("py","scripts\register_daily_pipeline_task.py","--enable-local-console-help-docs","--local-console-help-docs-output-dir","local_console_help","--time","15:30")
Clean-PythonCache
