...
$LogPath = Join-Path $LogDir "stage66_validation_$Stamp.log"
...
Write-Log "Stage66 validation started $($StartedAt.ToString('o'))"
...
$ReviewCommand = "py scripts\run_local_console_binding_review.py --repo-root . --output-dir local_console_binding_stage66 --local-console-shell-dir local_console_shell_stage65 --local-console-dashboard-dir local_console_dashboard_stage64 --local-console-detail-dir local_console_detail_stage63 --local-console-dir local_console_stage62 --api-gateway-dir api_gateway_stage61 --output local_console_binding_stage66\local_console_binding_report.md --json-output local_console_binding_stage66\local_console_binding_report.json --bundle-output local_console_binding_stage66\data_bundle.md --bundle-json-output local_console_binding_stage66\data_bundle.json --manifest-output local_console_binding_stage66\binding_manifest.md --manifest-json-output local_console_binding_stage66\binding_manifest.json --source-map-output local_console_binding_stage66\data_source_map.md --source-map-json-output local_console_binding_stage66\data_source_map.json --missing-output local_console_binding_stage66\missing_data_placeholders.md --missing-json-output local_console_binding_stage66\missing_data_placeholders.json --asset-output local_console_binding_stage66\bound_asset_index.md --asset-json-output local_console_binding_stage66\bound_asset_index.json --safety-output local_console_binding_stage66\static_data_safety.md --safety-json-output local_console_binding_stage66\static_data_safety.json --plan-output local_console_binding_stage66\next_console_preview_server_plan.md --plan-json-output local_console_binding_stage66\next_console_preview_server_plan.json"
Run-Command $ReviewCommand
Print-File "local_console_binding_stage66\local_console_binding_report.md"
Print-File "local_console_binding_stage66\data_bundle.md"
Print-File "local_console_binding_stage66\binding_manifest.md"
Print-File "local_console_binding_stage66\data_source_map.md"
Print-File "local_console_binding_stage66\missing_data_placeholders.md"
Print-File "local_console_binding_stage66\bound_asset_index.md"
Print-File "local_console_binding_stage66\static_data_safety.md"
Print-File "local_console_binding_stage66\next_console_preview_server_plan.md"
...
Run-Command "py scripts\run_daily_pipeline.py --cache-root market_data_test_stage66 --research-start 2026-03-21 --research-end 2026-06-18 --research-frequency 1d --min-bars 40 --cached-strategy-top-n 2 --enable-local-console-binding-review --local-console-binding-review-output-dir local_console_binding_stage66"
Run-Command "py scripts\run_scheduled_daily_pipeline.py --warmup-universe --warmup-provider mock --universe-lookback-days 90 --warmup-frequency 1d --cache-root market_data_test_stage66 --data-source-mode cached_real_first --research-start 2026-03-21 --research-end 2026-06-18 --research-frequency 1d --min-bars 40 --cached-strategy-top-n 2 --enable-local-console-binding-review --local-console-binding-review-output-dir local_console_binding_stage66"
Run-Command "py scripts\register_daily_pipeline_task.py --warmup-universe --warmup-provider mock --universe-lookback-days 90 --warmup-frequency 1d --cache-root market_data --data-source-mode cached_real_first --research-start 2026-03-21 --research-end 2026-06-18 --research-frequency 1d --min-bars 40 --cached-strategy-top-n 2 --enable-local-console-binding-review --local-console-binding-review-output-dir local_console_binding --time 15:30"
Clean-PythonCache
...
if ($script:HadError) { Write-Log "Stage66 validation FAILED"; exit 1 }
Write-Log "Stage66 validation PASSED"
exit 0
