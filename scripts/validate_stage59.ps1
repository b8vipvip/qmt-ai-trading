...
$LogPath = Join-Path $LogDir "stage59_validation_$Stamp.log"
...
Write-Log "Stage59 validation started $($StartedAt.ToString('o'))"
...
Run-Command "py" @("scripts\run_live_gray_readonly_seal.py","--repo-root",".","--output-dir","live_gray_readonly_seal_stage59")
Print-File "live_gray_readonly_seal_stage59\live_gray_readonly_seal.md"
Print-File "live_gray_readonly_seal_stage59\material_lock.md"
Print-File "live_gray_readonly_seal_stage59\pre_run_checklist.md"
Print-File "live_gray_readonly_seal_stage59\readonly_seal_manifest.md"
Print-File "live_gray_readonly_seal_stage59\final_signoff_recheck.md"
Print-File "live_gray_readonly_seal_stage59\next_pre_gray_review_plan.md"
...
Run-Command "py" @("scripts\warmup_etf_universe.py","--lookback-days","90","--frequency","1d","--provider","mock","--cache-root","market_data_test_stage59")
Run-Command "py" @("scripts\run_daily_pipeline.py","--cache-root","market_data_test_stage59","--research-start","2026-03-21","--research-end","2026-06-18","--research-frequency","1d","--min-bars","40","--cached-strategy-top-n","2","--enable-live-gray-readonly-seal","--live-gray-readonly-seal-output-dir","live_gray_readonly_seal_stage59")
Run-Command "py" @("scripts\run_scheduled_daily_pipeline.py","--warmup-universe","--warmup-provider","mock","--universe-lookback-days","90","--warmup-frequency","1d","--cache-root","market_data_test_stage59","--data-source-mode","cached_real_first","--research-start","2026-03-21","--research-end","2026-06-18","--research-frequency","1d","--min-bars","40","--cached-strategy-top-n","2","--enable-live-gray-readonly-seal","--live-gray-readonly-seal-output-dir","live_gray_readonly_seal_stage59")
Run-Command "py" @("scripts\register_daily_pipeline_task.py","--warmup-universe","--warmup-provider","mock","--universe-lookback-days","90","--warmup-frequency","1d","--cache-root","market_data","--data-source-mode","cached_real_first","--research-start","2026-03-21","--research-end","2026-06-18","--research-frequency","1d","--min-bars","40","--cached-strategy-top-n","2","--enable-live-gray-readonly-seal","--live-gray-readonly-seal-output-dir","live_gray_readonly_seal","--time","15:30")
...
if ($script:HadError) { Write-Log "Stage59 validation FAILED"; exit 1 }
Write-Log "Stage59 validation PASSED"
exit 0
