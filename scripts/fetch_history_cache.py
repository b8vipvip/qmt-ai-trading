...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Populate local historical bar cache in mock mode.")
    ...
    parser.add_argument("--provider", default="mock", choices=["mock"], help="Historical provider; only mock is available now")
...
def main() -> int:
    ...
    result = fetch_historical_bars(query, store=store, provider=MockHistoricalDataProvider())
