...
'powershell -NoProfile -Command "Get-Content -Path live_final_archive_stage50/live_final_archive.md -Encoding UTF8"','powershell -NoProfile -Command "Get-Content -Path live_final_archive_stage50/material_seal.md -Encoding UTF8"','powershell -NoProfile -Command "Get-Content -Path live_final_archive_stage50/human_closure.md -Encoding UTF8"','powershell -NoProfile -Command "Get-Content -Path live_final_archive_stage50/next_readonly_check_plan.md -Encoding UTF8"',
