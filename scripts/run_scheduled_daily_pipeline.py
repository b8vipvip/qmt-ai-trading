...
def main(argv: list[str] | None = None) -> int:
    ...
    if parsed.enable_live_final_review:
        args.append("--enable-live-final-review")
        args.extend(["--live-final-review-output-dir", parsed.live_final_review_output_dir])
    ...
    if parsed.enable_live_final_archive:
        args.append("--enable-live-final-archive")
        args.extend(["--live-final-archive-output-dir", parsed.live_final_archive_output_dir])
    if parsed.enable_live_archive_lock:
        args.append("--enable-live-archive-lock")
        args.extend(["--live-archive-lock-output-dir", parsed.live_archive_lock_output_dir])
    ...
    if parsed.enable_local_console_detail_review:
        args.append("--enable-local-console-detail-review")
        args.extend(["--local-console-detail-review-output-dir", parsed.local_console_detail_review_output_dir])
    if parsed.enable_local_console_dashboard_review:
        args.append("--enable-local-console-dashboard-review")
        args.extend(["--local-console-dashboard-review-output-dir", parsed.local_console_dashboard_review_output_dir])
    ...
    if parsed.enable_local_console_preview_review:
        args.append("--enable-local-console-preview-review")
        args.extend(["--local-console-preview-review-output-dir", parsed.local_console_preview_review_output_dir])
    if parsed.enable_local_console_refresh_review:
        args.append("--enable-local-console-refresh-review")
        args.extend(["--local-console-refresh-review-output-dir", parsed.local_console_refresh_review_output_dir])
