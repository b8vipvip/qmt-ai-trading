...
$LogPath = Join-Path $LogDir "stage69_validation_$Stamp.log"
...
$groupingCommand = "py scripts/run_local_console_grouping_review.py --repo-root . --output-dir local_console_grouping_stage69 --binding-dir local_console_binding_stage66 --refresh-dir local_console_refresh_stage68 --preview-dir local_console_preview_stage67 --output local_console_grouping_stage69/local_console_grouping_report.md --json-output local_console_grouping_stage69/local_console_grouping_report.json --manifest-output local_console_grouping_stage69/grouping_manifest.md --manifest-json-output local_console_grouping_stage69/grouping_manifest.json --filter-output local_console_grouping_stage69/filter_state_schema.md --filter-json-output local_console_grouping_stage69/filter_state_schema.json --grouped-output local_console_grouping_stage69/grouped_card_index.md --grouped-json-output local_console_grouping_stage69/grouped_card_index.json --search-output local_console_grouping_stage69/search_index.md --search-json-output local_console_grouping_stage69/search_index.json --safety-output local_console_grouping_stage69/frontend_grouping_safety_report.md --safety-json-output local_console_grouping_stage69/frontend_grouping_safety_report.json --plan-output local_console_grouping_stage69/next_console_drilldown_export_plan.md --plan-json-output local_console_grouping_stage69/next_console_drilldown_export_plan.json"
Run-Command $groupingCommand
Print-File "local_console_grouping_stage69/local_console_grouping_report.md"
Print-File "local_console_grouping_stage69/grouping_manifest.md"
Print-File "local_console_grouping_stage69/filter_state_schema.md"
Print-File "local_console_grouping_stage69/grouped_card_index.md"
Print-File "local_console_grouping_stage69/search_index.md"
Print-File "local_console_grouping_stage69/frontend_grouping_safety_report.md"
Print-File "local_console_grouping_stage69/next_console_drilldown_export_plan.md"
...
Run-Command "py scripts/run_daily_pipeline.py --cache-root market_data_test_stage69 --research-start 2026-03-21 --research-end 2026-06-18 --research-frequency 1d --min-bars 40 --cached-strategy-top-n 2 --enable-local-console-grouping-review --local-console-grouping-review-output-dir local_console_grouping_stage69"
Run-Command "py scripts/run_scheduled_daily_pipeline.py --warmup-universe --warmup-provider mock --universe-lookback-days 90 --warmup-frequency 1d --cache-root market_data_test_stage69 --data-source-mode cached_real_first --research-start 2026-03-21 --research-end 2026-06-18 --research-frequency 1d --min-bars 40 --cached-strategy-top-n 2 --enable-local-console-grouping-review --local-console-grouping-review-output-dir local_console_grouping_stage69"
Run-Command "py scripts/register_daily_pipeline_task.py --warmup-universe --warmup-provider mock --universe-lookback-days 90 --warmup-frequency 1d --cache-root market_data --data-source-mode cached_real_first --research-start 2026-03-21 --research-end 2026-06-18 --research-frequency 1d --min-bars 40 --cached-strategy-top-n 2 --enable-local-console-grouping-review --local-console-grouping-review-output-dir local_console_grouping --time 15:30"
Clean-PythonCache
...
if ($script:HadError) { Write-Log "Stage69 validation FAILED"; exit 1 }
Write-Log "Stage69 validation PASSED"
exit 0
