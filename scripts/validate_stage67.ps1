...
$LogPath = Join-Path $LogDir "stage67_validation_$Stamp.log"
...
Write-Log "Stage67 validation started $($StartedAt.ToString('o'))"
Run-Command "py -m compileall -q qmt_ai_trading"
$tests = @("tests/test_final_authorization_stage39.py","tests/test_redline_review_stage40.py","tests/test_live_gray_ledger_stage41.py","tests/test_live_gray_review_stage42.py","tests/test_live_signature_freeze_stage43.py","tests/test_live_env_snapshot_stage44.py","tests/test_live_runbook_stage45.py","tests/test_live_signoff_stage46.py","tests/test_live_final_review_stage47.py","tests/test_live_archive_stage48.py","tests/test_live_consistency_stage49.py","tests/test_live_final_archive_stage50.py","tests/test_live_archive_lock_stage51.py","tests/test_live_lock_consistency_stage52.py","tests/test_live_archive_verification_stage53.py","tests/test_live_gap_clearance_stage54.py","tests/test_qmt_dryrun_calibration_stage55.py","tests/test_real_cache_quality_stage56.py","tests/test_live_gray_candidate_stage57.py","tests/test_live_gray_final_approval_stage58.py","tests/test_live_gray_readonly_seal_stage59.py","tests/test_pre_gray_final_review_stage60.py","tests/test_api_gateway_stage61.py","tests/test_local_console_stage62.py","tests/test_local_console_detail_stage63.py","tests/test_local_console_dashboard_stage64.py","tests/test_local_console_shell_stage65.py","tests/test_local_console_binding_stage66.py","tests/test_local_console_preview_stage67.py")
foreach ($t in $tests) { Run-Command "py -m pytest $t" }
Run-Command "py scripts/run_local_console_preview_review.py --repo-root . --output-dir local_console_preview_stage67 --static-dir local_console_binding_stage66 --host 127.0.0.1 --port 8767 --dry-run --output local_console_preview_stage67/local_console_preview_report.md --json-output local_console_preview_stage67/local_console_preview_report.json --route-output local_console_preview_stage67/preview_route_map.md --route-json-output local_console_preview_stage67/preview_route_map.json --static-output local_console_preview_stage67/static_file_index.md --static-json-output local_console_preview_stage67/static_file_index.json --response-output local_console_preview_stage67/response_manifest.md --response-json-output local_console_preview_stage67/response_manifest.json --safety-output local_console_preview_stage67/preview_safety_boundary.md --safety-json-output local_console_preview_stage67/preview_safety_boundary.json --plan-output local_console_preview_stage67/next_console_refresh_plan.md --plan-json-output local_console_preview_stage67/next_console_refresh_plan.json"
Run-Command "py scripts/run_local_console_preview_server.py --repo-root . --static-dir local_console_binding_stage66 --host 127.0.0.1 --port 8767 --dry-run"
Run-Command "py scripts/run_local_console_preview_server.py --repo-root . --static-dir local_console_binding_stage66 --host 127.0.0.1 --port 8767 --serve-once --timeout-seconds 5"
Print-File "local_console_preview_stage67/local_console_preview_report.md"
Print-File "local_console_preview_stage67/preview_route_map.md"
Print-File "local_console_preview_stage67/static_file_index.md"
Print-File "local_console_preview_stage67/response_manifest.md"
Print-File "local_console_preview_stage67/preview_safety_boundary.md"
Print-File "local_console_preview_stage67/next_console_refresh_plan.md"
Run-Command "py scripts/check_stage53_roadmap_plan.py"
Check-NoBackup "scripts" "validate_stage66.ps1.bak_stage66fix_*" "Stage66 validate"
Check-NoBackup "scripts" "validate_stage67.ps1.bak_stage67fix_*" "Stage67 validate"
Run-Command "py scripts/run_daily_pipeline.py --cache-root market_data_test_stage67 --research-start 2026-03-21 --research-end 2026-06-18 --research-frequency 1d --min-bars 40 --cached-strategy-top-n 2 --enable-local-console-preview-review --local-console-preview-review-output-dir local_console_preview_stage67"
Run-Command "py scripts/run_scheduled_daily_pipeline.py --warmup-universe --warmup-provider mock --universe-lookback-days 90 --warmup-frequency 1d --cache-root market_data_test_stage67 --data-source-mode cached_real_first --research-start 2026-03-21 --research-end 2026-06-18 --research-frequency 1d --min-bars 40 --cached-strategy-top-n 2 --enable-local-console-preview-review --local-console-preview-review-output-dir local_console_preview_stage67"
Run-Command "py scripts/register_daily_pipeline_task.py --warmup-universe --warmup-provider mock --universe-lookback-days 90 --warmup-frequency 1d --cache-root market_data --data-source-mode cached_real_first --research-start 2026-03-21 --research-end 2026-06-18 --research-frequency 1d --min-bars 40 --cached-strategy-top-n 2 --enable-local-console-preview-review --local-console-preview-review-output-dir local_console_preview --time 15:30"
Clean-PythonCache
...
if ($script:HadError) { Write-Log "Stage67 validation FAILED"; exit 1 }
Write-Log "Stage67 validation PASSED"
exit 0
